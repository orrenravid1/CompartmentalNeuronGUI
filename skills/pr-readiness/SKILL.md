...
3. If the change added or renamed a repo-owned skill, use `register-skill`.
4. Use `update-docs-and-indexes` when code paths, package boundaries, public API, or workflow docs changed.
