...
Use this workflow when a branch is ready for review:
...
4. Verify the branch with `python scripts/pr_readiness.py verify --rerun-commands` in CI or another server-side harness.
