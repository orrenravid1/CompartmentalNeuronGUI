...
def test_jaxley_document_builder_splits_display_and_trace_fields():
    ...
    display_field = document.fields[JaxleyDocumentBuilder.DISPLAY_FIELD_ID]
    trace_field = document.fields[JaxleyDocumentBuilder.HISTORY_FIELD_ID]
    ...
    assert morphology_view.color_field_id == JaxleyDocumentBuilder.DISPLAY_FIELD_ID
    ...
    assert trace_view.field_id == JaxleyDocumentBuilder.HISTORY_FIELD_ID
...
def test_jaxley_session_captures_new_trace_history_on_click():
    ...
    assert updates[0].field_id == JaxleyDocumentBuilder.HISTORY_FIELD_ID
