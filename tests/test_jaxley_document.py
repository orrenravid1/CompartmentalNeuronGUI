...
def test_jaxley_document_builder_splits_display_and_trace_fields():
    ...
    trace_field = document.fields[JaxleyDocumentBuilder.TRACE_FIELD_ID]
    ...
    assert trace_view.field_id == JaxleyDocumentBuilder.TRACE_FIELD_ID
...
def test_jaxley_session_captures_new_trace_history_on_click():
    ...
    assert updates[0].field_id == JaxleyDocumentBuilder.TRACE_FIELD_ID
